<?php
class GF_Bidsketch_AddOnData{

    public static function update_table(){
        global $wpdb;
        $table_name = self::get_bidsketch_table_name();
    ...
    public static function get_bidsketch_table_name(){
        global $wpdb;
        return $wpdb->prefix . "rg_bidsketch";
    }
    ...
    public static function drop_tables(){
        global $wpdb;
        $wpdb->query("DROP TABLE IF EXISTS " . self::get_bidsketch_table_name());
    }
}